...
The 'type' and behaviour of the key is defined by the USBKeyFlags. There are three bytes defining the action for the pressed key.
	...
	*/
	    ...
	    */
        ...
        public class cusbKeyStruct
        {
            CUSBkeys.usbKeyStruct _usbKeyStruct = new usbKeyStruct();
            public CUSBkeys.usbKeyStruct usbKeyStruct
            {
                get { return _usbKeyStruct; }
                set { _usbKeyStruct = value; }
            }
            public cusbKeyStruct(byte bHID, CUsbKeyTypes.HWkeys hwKey, CUsbKeyTypes.usbFlagsHigh bFlagHigh, CUsbKeyTypes.usbFlagsMid bFlagMid, CUsbKeyTypes.usbFlagsLow bFlagLow, byte indexScancode)
            {
                _usbKeyStruct.bHID = bHID;
                _usbKeyStruct.bScanKey = hwKey;
                _usbKeyStruct.bFlagHigh = bFlagHigh;
                _usbKeyStruct.bFlagMid = bFlagMid;
                _usbKeyStruct.bFlagLow = bFlagLow;
                _usbKeyStruct.bIntScan = indexScancode;
            }
        }
        ...
        public class cusbKeyStructShort
        {
            usbKeyStructShort _shortStruct = new usbKeyStructShort();
            public usbKeyStructShort shortStruct
            {
                get { return _shortStruct; }
                set { _shortStruct = value; }
            }
            public cusbKeyStructShort(CUsbKeyTypes.usbFlagsHigh bFlagHigh, CUsbKeyTypes.usbFlagsMid bFlagMid, CUsbKeyTypes.usbFlagsLow bFlagLow, byte indexScancode)
            {
                _shortStruct.bFlagHigh = bFlagHigh;
                _shortStruct.bFlagMid = bFlagMid;
                _shortStruct.bFlagLow = bFlagLow;
                _shortStruct.bIntScan = indexScancode;
            }
        }
